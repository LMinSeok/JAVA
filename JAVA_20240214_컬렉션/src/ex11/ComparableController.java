...
public class ComparableController {
	...
	public static void main(String[] args) {
		...
		review.add(new Review(1, LocalDate.of(2022, 03, 16)));
		review.add(new Review(8, LocalDate.of(2023, 04, 17)));
		review.add(new Review(2, LocalDate.of(2021, 05, 18)));
		review.add(new Review(20, LocalDate.of(2020, 06, 19)));
